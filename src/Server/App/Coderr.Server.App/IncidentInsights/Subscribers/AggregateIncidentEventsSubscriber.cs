...
namespace Coderr.Server.App.IncidentInsights.Subscribers
{
    internal class AggregateIncidentEventsSubscriber
        : IMessageHandler<IncidentCreated>
            , IMessageHandler<IncidentClosed>
            , IMessageHandler<IncidentReOpened>
            , IMessageHandler<IncidentAssigned>
            , IMessageHandler<IncidentDeleted>
    {
