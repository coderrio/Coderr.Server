...
{
    /// <summary>
    /// Number of errors that was assigned during the month.
    /// </summary>
    [Metric(Name)]
    public class AssignedIncidentsMetricGenerator : IMetricGenerator
    {
        public const string Name = "AssignedIncidents";

        private readonly IAdoNetUnitOfWork _unitOfWork;

        public AssignedIncidentsMetricGenerator(IAdoNetUnitOfWork unitOfWork)
        {
        ...
        {
            DisplayName = "Assigned errors", Description = "Shows the number of errors that was assigned to someone during the month."
        };
