...
using EntityNotFoundException = Coderr.Server.Domain.EntityNotFoundException;
    ...
    public class CqsController : Controller
    {
        ...
        public async Task<IActionResult> Authenticate()
        {
            ...
            try
            {
                ...
                var dto = new AuthenticatedUser(User.GetAccountId(), User.Identity.Name)
                {
                    Applications = result,
        ...
        public async Task<IActionResult> Cqs()
        {
            ...
            if (!_cqsObjectMapper.HasType(cqsName))
            {
            ...
            try
            {
                ...
                if (RegisterCqsServices.IsQuery(cqsObject))
