IF EXIST "bin\Release\PublishOutput\appsettings.Development.json" (
  ...
  del /q bin\Release\PublishOutput\appsettings.Test.json
  del /q bin\Release\PublishOutput\appsettings.OnPremiseDev.json
  del /q bin\Release\PublishOutput\appsettings.Production.json
...
del /q bin\Release\PublishOutput\*.pdb
