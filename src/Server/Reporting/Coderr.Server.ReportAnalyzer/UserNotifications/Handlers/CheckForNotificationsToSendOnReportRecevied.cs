...
namespace Coderr.Server.ReportAnalyzer.UserNotifications.Handlers
{
    ...
    /// </summary>
    public class CheckForNotificationsToSendOnReportRecevied : IMessageHandler<ReportAddedToIncident>
    {
        ...
        /// <summary>
        ///     Creates a new instance of <see cref="CheckForNotificationsToSendOnReportRecevied" />.
        /// </summary>
