...
namespace Coderr.Server.ReportAnalyzer.UserNotifications.Handlers
{
    ...
    /// </summary>
    public class CheckForNotificationsToSendOnReportReceived : IMessageHandler<ReportAddedToIncident>
    {
        ...
        /// <summary>
        ///     Creates a new instance of <see cref="CheckForNotificationsToSendOnReportReceived" />.
        /// </summary>
