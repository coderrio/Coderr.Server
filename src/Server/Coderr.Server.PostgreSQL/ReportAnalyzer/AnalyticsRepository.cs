...
using Coderr.Server.PostgreSQL.ReportAnalyzer.Jobs;
        ...
        public void CreateIncident(IncidentBeingAnalyzed incident)
        {
            ...
            using (var cmd = _unitOfWork.CreateCommand())
            {
                cmd.CommandText =
                    ...
                    " VALUES (@ReportHashCode, @ApplicationId, @CreatedAtUtc, @HashCodeIdentifier, @StackTrace, @ReportCount, @UpdatedAtUtc, @Description, @FullName, 0, @LastReportAtUtc);RETURNING Id;";
